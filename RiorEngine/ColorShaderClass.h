...
// Set Shader program >> After the shader program is used to make buffers like vertex, index
// Ps. Constant buffer is set in this class.
...
private:
	...
	ID3D11Buffer* m_matrixBuffer;	// Dynamic constant buffer: A Resource that is accessible by both GPU and the CPU.
